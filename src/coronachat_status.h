...
enum coronachat_status {
    ...
    CORORNACHAT_STATUS_UI_PRINT_INPUT_BOX_COLOR_ON_FAILED,
    CORORNACHAT_STATUS_UI_PRINT_INPUT_BOX_COLOR_OFF_FAILED,
    ...
    CORORNACHAT_STATUS_UI_INIT_SCREEN_COLORS_FAILED,
    CORORNACHAT_STATUS_UI_INIT_SCREEN_PAIR_COLORS_FAILED,
